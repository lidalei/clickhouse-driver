...
class BlockOutputStream(object):
    def __init__(self, fout, server_info):
        self.fout = fout
    ...
    def write(self, block):
        ...
        for i, (col_name, col_type) in enumerate(block.columns_with_types):
            ...
            if n_columns:
                ...
                write_column(self.server_info, col_name, col_type, items,
...
class BlockInputStream(object):
    def __init__(self, fin, server_info):
        self.fin = fin
        self.server_info = server_info
    ...
    def read(self):
        ...
        for i in range(n_columns):
            ...
            if n_rows:
                column = read_column(self.server_info, column_type, n_rows,
                                     self.fin)
                data.append(column)
